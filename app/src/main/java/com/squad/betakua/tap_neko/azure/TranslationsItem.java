...
public class TranslationsItem {
    ...
    public String getZh_Hans() { return zh_Hans; }
    public String getYue() { return yue; }
    public String getEs() { return es; }
    public String getFil() { return fil; }
    ...
    public void setZh_Hans(String zh_Hans) { this.zh_Hans = zh_Hans; }
    public void setYue(String yue) { this.yue = yue; }
    public void setEs(String es) { this.es = es; }
    public void setFil(String fil) { this.fil = fil; }
    public void setAr(String ar) { this.ar = ar; }
    public void setDe(String de) { this.de = de; }
    public void setKo(String ko) { this.ko = ko; }
}
